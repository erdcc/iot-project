...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bc8458, const void *arg_0xb7bc85f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b798c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a23840), 
int (*key_eq_fn)(void *arg_0xb7a23c88, void *arg_0xb7a23e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78f29b8, int arg_0xb78f2b10);
static double RandomUniform(void );
...
static const char *RANDOM_KEY[4] = { 
...
typedef TMilli SmartBraceletC$Timer60s$precision_tag;
typedef TMilli SmartBraceletC$TimerPairing$precision_tag;
typedef TMilli SmartBraceletC$Timer10s$precision_tag;
...
static void SmartBraceletC$Timer60s$fired(void );
#line 83
static void SmartBraceletC$TimerPairing$fired(void );
#line 83
static void SmartBraceletC$Timer10s$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$Timer60s$startOneShot(uint32_t dt);
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
...
message_t * amsg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$Timer10s$startPeriodic(uint32_t dt);
...
#line 88
static inline void SmartBraceletC$Timer10s$fired(void );
...
static inline void SmartBraceletC$Timer60s$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$Timer60s$startOneShot(uint32_t dt){
#line 73
...
#line 146
{
  ...
  sim_log_debug(165U, "Radio_pack", "Payload: type: %hu, msg_id: %hhu, data: %s\n", __nesc_ntoh_uint8(mess->msg_type.nxdata), __nesc_ntoh_uint8(mess->msg_id.nxdata), mess->data);

  if (SmartBraceletC$AMPacket$destination(bufPtr) == AM_BROADCAST_ADDR && SmartBraceletC$phase[sim_node()] == 0 && memcmp(mess->data, RANDOM_KEY[TOS_NODE_ID / 2], 20) == 0) {
      SmartBraceletC$address_coupled_device[sim_node()] = SmartBraceletC$AMPacket$source(bufPtr);
      SmartBraceletC$phase[sim_node()] = 1;
      sim_log_debug(166U, "Radio_pack", "Message for PAIRING request has been received. Address: %hhu\n", SmartBraceletC$address_coupled_device[sim_node()]);
...
#line 158
    if (SmartBraceletC$AMPacket$destination(bufPtr) == TOS_NODE_ID && __nesc_ntoh_uint8(mess->msg_type.nxdata) == 1) {
        ...
        sim_log_debug(167U, "Radio_pack", "Message for CONFIRMATION has been received\n");
...
#line 163
      if (SmartBraceletC$AMPacket$destination(bufPtr) == TOS_NODE_ID && __nesc_ntoh_uint8(mess->msg_type.nxdata) == 2) {
          ...
          sim_log_debug(168U, "Radio_pack", "INFO message has been received\n");
          sim_log_debug(169U, "Info", "Position X: %hu, Y: %hu\n", __nesc_ntoh_uint8(mess->X.nxdata), __nesc_ntoh_uint8(mess->Y.nxdata));
          sim_log_debug(170U, "Info", "Sensor status: %s\n", mess->data);
          SmartBraceletC$last_status[sim_node()].X = __nesc_ntoh_uint8(mess->X.nxdata);
          SmartBraceletC$last_status[sim_node()].Y = __nesc_ntoh_uint8(mess->Y.nxdata);
          SmartBraceletC$Timer60s$startOneShot(60000);


          if (memcmp(mess->data, "FALLING", 20) == 0) {
              sim_log_debug(171U, "Info", "ALERT: FALLING!\n");
            }
        }
      }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7693ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7693ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7693ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb75109f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb75109f8, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7693108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb7693108, msg, error);
#line 110
}
#line 110
...
#line 53
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$Timer10s$startPeriodic(uint32_t dt){
#line 64
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7690178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7690178, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7510010, message_t * msg, error_t error){
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7510010, msg, error);
#line 100
      break;
#line 100
    }
...
#line 21
{
  ...
  int random_x = /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 10;
  int random_y = /*SmartBraceletAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 10;
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb784e650){
#line 75
  switch (arg_0xb784e650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb784e650);
#line 75
      break;
#line 75
    }
...
#line 126
# 67 "SmartBraceletC.nc"
static inline void SmartBraceletC$TimerPairing$fired(void )
#line 67
{
  SmartBraceletC$counter[sim_node()]++;
  sim_log_debug(150U, "TimerPairing", "TimerPairing: timer fired @ %s\n", sim_time_string());
  if (!SmartBraceletC$busy[sim_node()]) {
      ...
      __nesc_hton_uint8(sb_pairing_message->msg_id.nxdata, SmartBraceletC$counter[sim_node()]);
...
#line 88
{
  sim_log_debug(152U, "Timer10s", "Timer10s: timer fired at time %s\n", sim_time_string());
...
#line 95
{
  sim_log_debug(153U, "Timer60s", "Timer60s: timer fired at time %s\n", sim_time_string());
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7393c70){
#line 83
  switch (arg_0xb7393c70) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      SmartBraceletC$Timer10s$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      SmartBraceletC$Timer60s$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7393c70);
#line 83
      break;
#line 83
    }
...
#line 206
{
  ...
  if (!SmartBraceletC$busy[sim_node()]) {
      ...
      if (SmartBraceletC$AMSend$send(SmartBraceletC$address_coupled_device[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(sb_msg_t )) == SUCCESS) {
          sim_log_debug(174U, "Radio", "Radio: sending pairing confirmation to node %hhu\n", SmartBraceletC$address_coupled_device[sim_node()]);
          SmartBraceletC$busy[sim_node()] = TRUE;
        }
    }
}
...
#line 104
{
  if (&SmartBraceletC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      ...
      if (SmartBraceletC$phase[sim_node()] == 1 && SmartBraceletC$PacketAcknowledgements$wasAcked(bufPtr)) {
          ...
          sim_log_debug(158U, "Pairing", "PAIRING completed for node: %hhu\n", SmartBraceletC$address_coupled_device[sim_node()]);
...
#line 121
            {
              ...
              SmartBraceletC$Timer10s$startPeriodic(10000);
            }
        }
      else {
#line 127
        if (SmartBraceletC$phase[sim_node()] == 1) {
            ...
            sim_log_debug(161U, "Radio_ack", "CONF-ACK not received at time %s\n\n", sim_time_string());
            SmartBraceletC$send_confirmation();
          }
        else {
#line 132
...
#line 228
{
  ...
  if (SmartBraceletC$attempt[sim_node()] < 3) {
      ...
      if (!SmartBraceletC$busy[sim_node()]) {
          ...
          __nesc_hton_uint8(sb_pairing_message->X.nxdata, SmartBraceletC$status[sim_node()].X);
          __nesc_hton_uint8(sb_pairing_message->Y.nxdata, SmartBraceletC$status[sim_node()].Y);
          memcpy(sb_pairing_message->data, SmartBraceletC$status[sim_node()].status, 20);
